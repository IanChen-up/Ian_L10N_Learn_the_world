...
const STATE_AR = {
  ...
  Delaware: "ديلاوير",
  "District of Columbia": "واشنطن العاصمة",
  Florida: "فلوريدا",
  Georgia: "جورجيا",
  Hawaii: "هاواي",
  Idaho: "أيداهو",
    ...
    highlights: [
      {
        ...
        note: {
          zh: highlight,
          en: `${nameEn} has a distinct local identity shaped by its geography, settlement history, industries, and regional culture. Use this card as a quick state-level localization overview rather than treating the United States as one uniform market.`,
        },
      },
      {
      ...
      {
        name: { zh: "本地化提示", en: "Localization cue" },
        note: {
          zh: `邮政缩写为 ${abbr}。美国地址、税务、教育、新闻和法律语境经常以州为单位区分。`,
          en: `Postal abbreviation: ${abbr}. In U.S. localization, addresses, taxes, education, news, legal rules, and public services are often handled at the state level.`,
        },
      },
      {
        name: { zh: "学习重点", en: "Learning focus" },
        note: {
          zh: "阅读州级信息时，可重点观察首府、最大城市、产业结构、族群构成、地方节庆和州政府规则的差异。",
          en: "When reading state-level information, compare the capital, largest metro areas, industry mix, demographic patterns, local festivals, and state government rules.",
        },
      },
    ],
  };
